            ...
            <div class="col-md-12">
                <div class="event-box">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="display-5 text-light">{{$event->name}}</h1>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <a href="/event/{{$event->id}}" class="btn btn-lg btn-light mt-3">Learn More</a>
                            </div>
                            <div class="col-auto">
                                <a href="{{$event->link}}" class="btn btn-lg btn-outline-light mt-3">Visit Social Event Link</a>
                            </div>
                        </div>
                    </div>
                </div>
